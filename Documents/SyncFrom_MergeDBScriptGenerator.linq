...
Dictionary<string, string> RemoteDBs = new Dictionary<string, string>
{
	{"Emerald_Transformer","Finventory"},
	{"4-Way_Electric","Finventory_Test"},
	{"Garrett_and_Son_Inc","Finventory_Test"},
	{"Transformer_Gaskets_&_Components","Finventory_Test"},
	{"Transformer_Decommissioning_Inc","Finventory_Test"},
	{"Environmental_Management_Systems","Finventory_Test"}
}
...
foreach (var location in this.Locations.Where(l => l.Id > 1))
{
