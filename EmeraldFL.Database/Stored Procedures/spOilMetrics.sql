...
/****** Object:  StoredProcedure [dbo].[spOilMetrics]    Script Date: 6/18/2020 11:57:17 PM ******/
SET ANSI_NULLS ON
GO
...
-- Description:	This SP Fetch summary for Oil's Gallons and Revenue seperately
...
--exec spOilMetrics '1,13',2019,10,'','','Summary'
--exec spOilMetrics '1,13',2019, 11, '','','Detail' --For Monthly Detail
--exec spOilMetrics '1,13',2019, 11, '','','GrandTotal'--For Yearly Detail 
--exec spOilMetrics '1,13',2019, 11, '','','GrandTotal'--For Yearly Detail 


CREATE PROCEDURE [dbo].[spOilMetrics]
...
BEGIN
		...
		Begin
			...
			)a group by Entity, OilPeriod, fiscalyear,fiscalperiod
